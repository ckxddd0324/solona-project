...
const TOKEN_NAME = "RNDM";
const TOKEN_SYMBOL = "RNDM";
const TOKEN_DESCRIPTION = "A token for Randome avaar";
const TOKEN_IMAGE_NAME = "mina_buff_miguin.png"; // Replace unicorn.png with your image name
